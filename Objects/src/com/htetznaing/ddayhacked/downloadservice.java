...
public class downloadservice extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.htetznaing.ddayhacked", "com.htetznaing.ddayhacked.downloadservice");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.ddayhacked.downloadservice", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public boolean IsInitialized;
public com.htetznaing.ddayhacked.downloadservice._downloaddata Data;
public anywheresoftware.b4a.randomaccessfile.CountingStreams.CountingOutput CountingStream;
public long Total;
public void Initialize() {
IsInitialized = true;
Data = new com.htetznaing.ddayhacked.downloadservice._downloaddata();
...
_job = (com.htetznaing.ddayhacked.httpjob)(_jobs.Get((Object)(_url)));
 //BA.debugLineNum = 67;BA.debugLine="Dim jt As JobTag = job.Tag";
_jt = (com.htetznaing.ddayhacked.downloadservice._jobtag)(_job._tag);
...
public static String  _jobdone(com.htetznaing.ddayhacked.httpjob _job) throws Exception{
com.htetznaing.ddayhacked.downloadservice._jobtag _jt = null;
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed3(processBA,_jt.Data.Target,_jt.Data.EventName+"_Progress",(Object)(_jt.CountingStream.getCount()),(Object)(_jt.Total));
 //BA.debugLineNum = 92;BA.debugLine="CallSubDelayed2(jt.Data.Target, jt.Data.EventNam";
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(processBA,_jt.Data.Target,_jt.Data.EventName+"_Complete",(Object)(_job));
 }else {
...
public static String  _startdownload(com.htetznaing.ddayhacked.downloadservice._downloaddata _data) throws Exception{
com.htetznaing.ddayhacked.httpjob _j = null;
com.htetznaing.ddayhacked.downloadservice._jobtag _tag = null;
...
_j = new com.htetznaing.ddayhacked.httpjob();
 //BA.debugLineNum = 51;BA.debugLine="J.Initialize(data.url, Me)";
_j._initialize(processBA,_data.url,downloadservice.getObject());
 //BA.debugLineNum = 52;BA.debugLine="Dim tag As JobTag";
_tag = new com.htetznaing.ddayhacked.downloadservice._jobtag();
...
_n.setLight(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 33;BA.debugLine="n.SetInfo(\"Downloading Obb File...\", \"\", Target)";
_n.SetInfo(processBA,"Downloading Obb File...","",_target);
...
_job = (com.htetznaing.ddayhacked.httpjob)(group1.Get(index1));
...
anywheresoftware.b4a.keywords.Common.CallSubNew3(processBA,_jt.Data.Target,_jt.Data.EventName+"_Progress",(Object)(_jt.CountingStream.getCount()),(Object)(_jt.Total));
 };
 }
;
